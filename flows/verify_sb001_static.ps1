...
Require-Text $dockerfile "VOLARE_SKY130_TAG=sky130-fa87f8f4bbcc7255b6f0c0fb506960f531ae2392"`r`nRequire-Text $dockerfile "VOLARE_SKY130_HD_SHA256=d4081b3c0fbfa2afe31dba789c03157ad137ea08b11910e2c8b3ec81b2a61bf6"
...
$bad = Select-String -LiteralPath $dockerfile,$versions -Pattern "REPLACE_WITH|OSS_CAD_SUITE_DATE|2025-10-14|SKY130_FD_SC_HD_COMMIT|skywater-pdk-libs-sky130_fd_sc_hd|OPEN_PDKS_REF|OPEN_PDKS_COMMIT" -ErrorAction SilentlyContinue
if ($bad) {
